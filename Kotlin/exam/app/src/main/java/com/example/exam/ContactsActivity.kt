...
class ContactsActivity : AppCompatActivity() {
    ...
    fun createPhoneBookLisk(phoneBook: PhoneBook) {
        val layoutInflater = LayoutInflater.from(this@ContactsActivity)
    ...
    fun addSetOnClickListener(person:Person, view:View) {
        view.setOnClickListener {
            val intent = Intent(this@ContactsActivity,
