...
class HenrystagramPostListActivity : AppCompatActivity() {

    lateinit var glide: RequestManager

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_henrystagram_post_list)
                ...
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        val adapter = PostAdapter(
                            postList!!,
                            LayoutInflater.from(this@HenrystagramPostListActivity),
                            glide
                        )
                        post_recylerview.adapter = adapter
                        post_recylerview.layoutManager =
                            LinearLayoutManager(this@HenrystagramPostListActivity)
                    }
                }
        ...
        user_info.setOnClickListener { startActivity(Intent(this,
